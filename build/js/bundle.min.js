function darkMode(){const e=window.matchMedia("(prefers-color-scheme: dark)");e.matches?document.body.classList.add("dark-btn"):document.body.classList.remove("dark-btn"),e.addEventListener("change",(function(){e.matches?document.body.classList.add("dark-btn"):document.body.classList.remove("dark-btn")}));document.querySelector(".dark-mode").addEventListener("click",(function(){document.body.classList.toggle("dark-btn")}))}function EventListeners(){document.querySelector(".navegacion-mobil").addEventListener("click",navegacionResponsive)}function navegacionResponsive(){document.querySelector(".navegation").classList.toggle("mostrar")}
